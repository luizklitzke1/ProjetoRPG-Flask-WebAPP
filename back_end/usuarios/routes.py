...
from back_end.usuarios.forms import (Form_Registrar_Usuario, Form_Logar_Usuario, Form_Editar_Conta,
                                        Form_Requisitar_Recuperacao, Form_Alterar_Senha)
from back_end.models_db import Usuario, Personagem
from back_end import app, db, bcrypt, mail
